...
/**
 * Instructor upload form and "My Videos" list.
 * Handles video submission to POST /api/videos and displays
 * only the current instructor's uploaded content.
 */
export default function InstructorUploadPage() {
  ...
  /** Fetch only this instructor's videos on mount */
  useEffect(() => {
